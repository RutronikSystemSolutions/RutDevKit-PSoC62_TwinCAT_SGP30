...
**    ABCC_StartRespSegmentationSession() - Send a segmented response message to ABCC
...
**    ABCC_NetFormatType()                - Get network endian.
...
** See description of ABCC_StartRespSegmentationSession().
**------------------------------------------------------------------------------
** Arguments:
**       pxObject   - User defined (Supplied in ABCC_StartRespSegmentationSession())
**
** Returns:
**       None.
**------------------------------------------------------------------------------
...
** handler. Note that the size of the block is unrelated to the segment size used
** by the driver i.e. the segment size does not need to be known by the callback
** function.
**
** See ABCC_StartRespSegmentationSession
**------------------------------------------------------------------------------
** Arguments:
**       pxObject   - User defined (Supplied in ABCC_StartRespSegmentationSession)
...
*/
#if ABCC_CFG_DEBUG_ERR_ENABLED
#define ABCC_DEBUG_ERR( args ) ABCC_PORT_DebugPrint( args )
#else
...
/*------------------------------------------------------------------------------
** Get message channel size in number of octets.
**------------------------------------------------------------------------------
** Arguments:
**    None
**
