...
** These defines shall be specified by the user in abcc_drv_cfg.h and abcc_td.h.
********************************************************************************
********************************************************************************
** Services:
**   None
...
/*------------------------------------------------------------------------------
** #define ABCC_CFG_PAR_EXT_BUS_ENDIAN_DIFF      (BOOL - TRUE/FALSE)
**
** Defined in abcc_td.h.
**
** Define as TRUE if the internal and external memory bus of the host
** application processor have different endianess.
** The default behavior, if not defined at all, is 'no endian swap'.
**------------------------------------------------------------------------------
*/
