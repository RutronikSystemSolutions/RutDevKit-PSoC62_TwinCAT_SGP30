...
static UINT16 appl_iSmEventMissed;
static UINT16 appl_iCycleTimeTooSmall;
static UINT16 appl_iShiftTimeTooShort;
static BOOL   appl_fSyncError;
#endif
...
#if ECT_SUPPORT_SYNC_ERR_COUNTERS
   { ECT_SUB_TRANS_1C32_11, "SM-Event Missed",      ABP_UINT16, 1, APPL_NOT_MAP_READ_ACCESS_DESC,   { { &appl_iSmEventMissed, NULL } }     },
   { ECT_SUB_TRANS_1C32_12, "Cycle Time Too Small", ABP_UINT16, 1, APPL_NOT_MAP_READ_ACCESS_DESC,   { { &appl_iCycleTimeTooSmall, NULL } } },                                        \
   { ECT_SUB_TRANS_1C32_13, "Shift Time Too Short", ABP_UINT16, 1, APPL_NOT_MAP_READ_ACCESS_DESC,   { { &appl_iShiftTimeTooShort, NULL } } },                                        \
   { ECT_SUB_TRANS_1C32_32, "Sync Error",           ABP_BOOL1,  1, APPL_WRITE_MAP_READ_ACCESS_DESC, { { &appl_fSyncError, NULL } }         },                                        \
   { ECT_SUB_TRANS_1C33_12, "Cycle Time Too Small", ABP_UINT16, 1, APPL_NOT_MAP_READ_ACCESS_DESC,   { { &appl_iCycleTimeTooSmall, NULL } } }
#endif
};
...
{
   { 50, PD_READ,  AD_MAP_ALL_ELEM, 0 },
   { 51, PD_WRITE, AD_MAP_ALL_ELEM, 0 },
   { AD_MAP_END_ENTRY }
};
